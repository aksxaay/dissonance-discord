function cartify(string, param) {
	// get the original text
	try {var userInput = document.getElementById("userinput").value;}
    catch(err) { var userInput = string}
